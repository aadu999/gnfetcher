[![PyPI](https://img.shields.io/badge/PyPi-v1.1.0-f39f37.svg)](https://pypi.python.org/pypi/gnfetcher)
[![license](https://img.shields.io/github/license/mashape/apistatus.svg?maxAge=2592000)](https://github.com/nikhilkumarsingh/gnfetcher/blob/master/LICENSE.txt)
...
To install and use **gnfetcher CLI**, follow instructions here [CLI](CLI.md)
